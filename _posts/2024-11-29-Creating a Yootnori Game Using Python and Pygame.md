...
이와 같이, **애자일 방법론은 팀의 상황에 따라 큰 장점을 발휘**할 수도 있지만, **팀 내의 역량 불균형과 목표의 불명확성**으로 인해 단점이 될 수도 있음을 이번 프로젝트를 통해 실감하였습니다. 이를 통해 애자일이 항상 옳은 방법은 아니며, **상황과 팀의 특성**에 맞는 적절한 접근이 필요하다는 점을 배웠습니다.